...
This outlines how to propose a change to rvest. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tidyverse/rvest", fork = TRUE)`.
...
of Conduct](https://rvest.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
