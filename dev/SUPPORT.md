...
Thanks for using rvest! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tidyverse/rvest/issues/new).
...
requests](https://github.com/tidyverse/rvest/issues) to make sure the
